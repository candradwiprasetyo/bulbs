          ...
          <div class="profile_left_content">
            <div class="col-md-11 col-md-offset-1" >
                  ...
                  <div class="form-group">
                                      <div class="profile_name">Edit Image</div>
                        ...
                        <div class="col-md-12" >
                          ...
                          <div class="form-group">
                            ...
                            <img src="<?= site_url() ?>assets/images/project/detail/<?= $data_project['pdi_value']?>" style="width:100%;">
                          ...
                          <div class="form-group" id="frame_img">
                            <div class="img_cover_image">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-3" >
                                  <a class="btn button_creatives" href="<?= site_url('project/form_edit/'.$data_project['project_id']); ?>" />CANCEL</a>
                                </div>
