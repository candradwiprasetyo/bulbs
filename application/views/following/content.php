                        ...
                        <div class="col-md-5">
                               ...
                               <?php
                                if($this->session->userdata('user_type_id')){
                                   ...
                                   <a href="<?=site_url('following/unfollowing/'.$r_c['user_id']); ?>" class="btn btn-danger" style="width:120px; border-radius:0px;">Unfollow</a>
                                <?php
								}else{
                                ?>
								<a href="<?=site_url('following/following/'.$r_c['user_id']); ?>" class="btn btn-primary" style="width:120px; border-radius:0px;">FOLLOW</a>
                                <?php
								}
								}
								?>
